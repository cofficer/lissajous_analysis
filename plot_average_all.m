function plot_average_all
  ...
  runplot.timewindow  = [-0.5 -0.2];
  runplot.sensors     = 'all'; %all, occipital
  runplot.data        = 'stable'; %SvsN, stable, switch, combined
  ...
  case 'topo'
    ...
    if runplot.multi
      ...
      %ft_hastoolbox('brewermap', 1);
      colormap(flipud(brewermap(64,'RdBu')))
      namefigure = sprintf('prelim3_%s_%s_%TOPO',runplot.data,runplot.freqrange,timewindow);
    end
