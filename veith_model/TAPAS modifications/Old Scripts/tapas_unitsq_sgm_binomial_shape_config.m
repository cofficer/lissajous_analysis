...
c.logAssociativePrecMu=log(10);
c.logAssociativePrecSa=0.001;

c.logSensoryMemoryPrecMu=log(10);
c.logSensoryMemoryPrecSa=0.001;

c.logPrimingPrecMu=log(10);
c.logPrimingPrecSa=0.001;
...
% Model filehandle
c.obs_fun = @tapas_unitsq_sgm_binomial_shape;
