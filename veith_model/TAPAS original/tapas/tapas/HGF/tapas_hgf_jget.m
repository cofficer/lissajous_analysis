...
infStates(:,1,3)  = traj.muxhat;
infStates(:,1,4)  = traj.saxhat;
infStates(:,1,5)  = traj.muahat;
infStates(:,1,6)  = traj.saahat;
infStates(:,1,7)  = traj.mux;
infStates(:,1,8)  = traj.sax;
infStates(:,1,9)  = traj.mua;
infStates(:,1,10) = traj.saa;
