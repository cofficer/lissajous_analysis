...
namefigure = sprintf('prelim13_low_TFR_Stim_off_baseline_4-45s');%Stage of analysis, frequencies, type plot, baselinewindow
...
% cfg.ylim         = [10 20];
cfg.layout       = 'CTF275_helmet.lay';
cfg.xlim         = [5.6 6];%[2 2.25];%[0.5 4 ];%[2.1 2.4];%
% cfg.channel      = freq.label(idx_occ);
cfg.interactive = 'no';
...
formatOut = 'yyyy-mm-dd';
todaystr = datestr(now,formatOut);
namefigure = sprintf('prelim13_low_stimOff_baseAvg_4-45s_56-6s');%Stage of analysis, frequencies, type plot, baselinewindow
