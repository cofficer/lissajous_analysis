...
namefigure = sprintf('prelim12_high_TFR_Stim_off_baseline-050_1sResp');%Stage of analysis, frequencies, type plot, baselinewindow
...
% cfg.ylim         = [10 20];
cfg.layout       = 'CTF275_helmet.lay';
cfg.xlim         = [0.1 0.4];%[2 2.25];%[0.5 4 ];%[2.1 2.4];%
% cfg.channel      = freq.label(idx_occ);
cfg.interactive = 'no';
...
formatOut = 'yyyy-mm-dd';
todaystr = datestr(now,formatOut);
namefigure = sprintf('prelim12_high_TOPO_60-90Hz_baseline-050_1sResp');%Stage of analysis, frequencies, type plot, baselinewindow
