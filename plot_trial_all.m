...
namefigure = sprintf('prelim13_high_TFR_Stim_off_baseline_4-45s_avg_4-45s');%Stage of analysis, frequencies, type plot, baselinewindow
...
% cfg.ylim         = [10 20];
cfg.layout       = 'CTF275_helmet.lay';
cfg.xlim         = [4.9 5.4];%[2 2.25];%[0.5 4 ];%[2.1 2.4];%
% cfg.channel      = freq.label(idx_occ);
cfg.interactive = 'no';
...
formatOut = 'yyyy-mm-dd';
todaystr = datestr(now,formatOut);
namefigure = sprintf('prelim13_high_stimOff_60-90Hz_baseWhole_4-45s_time_49-54s');%Stage of analysis, frequencies, type plot, baselinewindow
